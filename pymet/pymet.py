...
def main():
    ...
    parser.add_option("-s", "--stopid", action="append", type="string",
                      dest="stop_num",
                      help="the stop id we're looking for,"
                      "you can have more than one as long as"
                      "each stop id is preceded by -s")
    parser.add_option("-r", "--routeid", action="store", type="string",
                      dest="route_num",
                      help="the route id we're looking for")
